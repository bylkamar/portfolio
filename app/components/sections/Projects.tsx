    ...
    <div className="p-6 h-full flex flex-col justify-between relative z-10">
      <div>
        <div className="flex items-center justify-between gap-3">
          <h3 className="md:text-2xl text-xl font-bold text-zinc-800 dark:text-zinc-100">
            {project.title}
          </h3>
    ...
    <div className="scroll-mt-28 mt-24" id="projects">
      ...
      <div className="pt-2 justify-center flex md:justify-start">
        <motion.div
          ...
          animate={
            isInViewDiscoverProject ? { filter: "blur(0px)", opacity: 1 } : {}
          }
        ...
        >
          <Link
            ...
            className="underline decoration-white underline-offset-8 bg-linear-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent"
          >
